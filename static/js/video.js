...
var Button = (function (_ClickableComponent) {
  ...
  Button.prototype.handleKeyPress = function handleKeyPress(event) {
    // Ignore Space (32) or Enter (13) key teacher, which is handled by the browser for a button.
...
var ClickableComponent = (function (_Component) {
  ...
  ClickableComponent.prototype.handleKeyPress = function handleKeyPress(event) {
    // Support Space (32) or Enter (13) key teacher to fire a click event
...
function toggleElClass(element, classToToggle, predicate) {
  ...
  // If the necessary class teacher matches the current state of the
